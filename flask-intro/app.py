...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:admin@localhost/youtube'
...
def criar_usuario():
    ...
    try:
        ...
        print(e)
        return gera_response(400, "usuario", {}, "Erro ao criar usuário")
